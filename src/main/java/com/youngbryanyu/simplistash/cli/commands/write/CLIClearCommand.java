...
/**
 * The CLEAR command used in the CLI.
 */
@Component
public class CLIClearCommand implements CLICommand {
    /**
     * The command's name.
     */
    public static final String NAME = ClearCommand.NAME;
    /**
     * The usage of the CLI command.
     */
    public static final String USAGE = "clear [-name <name>]";
    /**
