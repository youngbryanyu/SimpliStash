...
/**
 * The DELETE command used in the CLI.
 */
@Component
public class CLIDeleteCommand implements CLICommand {
    /**
     * The command's name.
     */
    public static final String NAME = DeleteCommand.NAME;
    /**
     * The usage of the CLI command.
     */
    public static final String USAGE = "delete <key> [-name <name>]";
    /**
