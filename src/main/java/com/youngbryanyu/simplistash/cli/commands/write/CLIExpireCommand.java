...
/**
 * The EXPIRE command used in the CLI.
 */
@Component
public class CLIExpireCommand implements CLICommand {
    /**
     * The command's name.
     */
    public static final String NAME = ExpireCommand.NAME;
    /**
     * The usage of the CLI command.
     */
    public static final String USAGE = "expire <key> <ttl> [-name <name>]";
    /**
    ...
    public String encodeCLICommand(CommandLine commandLine) {
        ...
        /* Encode to protocol */
        return ProtocolUtil.encode(NAME, List.of(key, ttl), true, optArgMap);
    }
